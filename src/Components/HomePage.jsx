...
const HomePage = () => {
  return (
    <>
      ...
      <div className=' bg-[#d1fee60d] border border-[#262d2a] rounded-lg p-6 pr-24 my-10 mt-0 flex justify-between items-center'>
      ...
      <section className=' h-dvh w-full'>
        ...
        <div className=' w-full grid md:grid-cols-2 grid-cols-1 gap-5 h-[70%]'>
    ...
    <div className=' h-full w-full flex flex-col justify-center items-center gap-3 relative z-10 max-w-[1320px] mx-auto px-5'>
      <img src="../home_boostmain.svg" alt="boost main" className=' aspect-square h-3/5 object-contain object-center' />
...
<section className=' w-full flex lg:flex-row flex-col justify-between lg:items-start text-center'>
  <div className=' w-2/5 flex flex-col justify-start items-start p-5'>
    <h2 className=' text-3xl font-medium text-white my-2 mb-5 text-left'>Get the answers you need about Gloofi</h2>
    <button className=' w-fit px-5 py-2 rounded-lg bg-[#19fb80] font-medium text-base mt-6 text-black'>Read More</button>
  </div>
  <div className=' w-3/5'>
    {FaqData.map((data,i) => (
      ...
      <img src="../home_glow.svg" alt="glow" className=' z-10 w-1/2 h-dvh object-cover object-right fixed top-[20%] right-10 pointer-events-none' />

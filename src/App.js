...
<footer className=' bg-[#181b1a] py-12 mt-20'>
  <div className=' max-w-[1320px] xl:px-0 px-5 mx-auto flex lg:flex-row flex-col justify-between lg:items-start items-center'>
    ...
    <a title='Twitter' href="https://x.com/Gloofinance" target="_blank" rel="noopener noreferrer" className=' flex justify-center items-center h-16'>
...
<a title='Telegram' href="http://t.me/Gloofinance" target="_blank" rel="noopener noreferrer" className=' flex justify-center items-center h-16'>
<div className=' sm:size-16 size-10 flex justify-center items-center bg-[#d1fee60d] rounded'>
